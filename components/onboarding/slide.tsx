...
// Define or import the type onBoardingSlidesTypes
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        <View>{slide.image}</View> // Note :- image of the first interface you can change it according to you.
        <View>
          <View
            style={{
          ...
          >
            ...
            >
              {slide.secondTitle} //secnod title
            </Text>
            <Text
              style={{
...
const styles = StyleSheet.create({
  container: {
    ...
    padding: scale(60),
    paddingTop: verticalScale(100), //note :- they use the verticalscale for the responsive any of moblie 
    alignItems: "center",
  },
  indicatorContainer: {
    flexDirection: "row",
